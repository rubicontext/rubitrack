    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'date_collection_created',
                    models.DateTimeField(auto_now_add=True, null=True, verbose_name='date added to collection'),
                ),
                (
                    'date_collection_updated',
                    models.DateTimeField(
                        auto_now_add=True, null=True, verbose_name='date of modification in collection'
                    ),
                ),
                (
                    'date_collection_source_updated',
                    models.DateTimeField(
                        auto_now_add=True,
                        null=True,
                        verbose_name='date of modification in the source collection (Traktor/Serato/Rekordbox)',
                    ),
                ),
                ...
                (
                    'genre',
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='track.genre'
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'track_destination',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='destination', to='track.track'
                    ),
                ),
                (
                    'track_source',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='source', to='track.track'
                    ),
                ),
                (
                    'transition_type',
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, to='track.transitiontype'
                    ),
                ),
            ],
            options={
