    ...
    if request.method == 'POST':
        ...
        for track in suggestions:
            ...
            suggestions_data.append({
                ...
                'traktor_order': suggestion_key_obj.order if suggestion_key_obj else None,
            })
        ...
        # Tri des suggestions par ordre Traktor, puis limitation
        suggestions_data = sorted(suggestions_data, key=lambda x: x['traktor_order'] if x['traktor_order'] is not None else 999)
