...
from .pwa.views import manifest_view, overlay_manifest_view, service_worker_view
...
urlpatterns = [
    ...
    path('overlay/manifest.webmanifest', overlay_manifest_view, name='overlay_manifest'),
